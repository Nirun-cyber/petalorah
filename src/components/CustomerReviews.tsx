...
export const CustomerReviews: React.FC = () => {
  ...
  return (
    <section className="w-full py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      {/* Clean Static Reviews Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {displayReviews.map((rev) => (
          <div
            key={rev.id}
            className="p-4 rounded-2xl bg-white dark:bg-navy-light border border-rose-100/80 dark:border-white/10 shadow-sm flex flex-col justify-between"
          >
            <div>
              {/* Star Rating & Date */}
