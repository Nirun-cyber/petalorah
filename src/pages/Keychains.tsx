...
export const Keychains: React.FC<KeychainsProps> = ({ 
  ...
  const products: Product[] = [
    ...
    { id: 'evil_eye', name: 'Evil Eye', price: '₹60', description: 'A protective charm crafted with Concentric circles of royal blue, soft blue, and white pipe cleaners. A beautiful blend of folklore and handmade artistry.', img: '/assets/products/evil_eye.jpg', badge: 'Popular' },
    ...
    { id: 'bow', name: 'Bow', price: '₹45', description: 'A classic blue pipe cleaner ribbon bow keychain with an elegant pearl accent. Simple, elegant, and perfectly handcrafted, representing the pure aesthetics of line art crafts.', img: '/assets/products/bow.png', badge: 'Classic' },
    { id: 'custom_jersey', name: 'Customized Jersey', price: '₹80', description: 'Handcrafted custom sports jersey keychains tailored to your favorite numbers and teams. Perfect gift for sports enthusiasts and active creators.', img: '/assets/products/custom_jersey.jpg', badge: 'Unique Gift' },
    ...
    { id: 'sunflower', name: 'Sunflower', price: '₹80', description: 'A radiant handmade sunflower keychain featuring bright golden petals, a fluffy brown center, and vibrant green leaves. Crafted with precision wire twisting.', img: '/assets/products/sunflower.jpg', badge: 'Bright Bloom' },
    { id: 'luffy', name: 'Luffy Straw Hat', price: '₹90', description: 'Iconic One Piece Luffy straw hat keychain handcrafted from golden yellow pipe cleaners with a signature crimson red band accent. A must-have for anime fans!', img: '/assets/products/luffy.jpg', badge: 'Anime Special' },
  ...
  return (
    <div className="relative w-full min-h-screen bg-white dark:bg-navy pb-20">
      ...
      <section className="relative w-full py-10 z-20">
        ...
        <div className="w-full max-w-[95rem] mx-auto px-2 sm:px-6 mb-8 flex justify-start items-center">
        ...
        <div className="w-full max-w-[95rem] mx-auto px-2 sm:px-6 grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-1.5 sm:gap-6">
          {(() => {
